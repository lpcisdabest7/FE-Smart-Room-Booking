...
export default function Header({ userEmail, onLogout, onNewChat }: HeaderProps) {
  return (
    <header className="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between shrink-0">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-lg font-bold text-gray-900">Smart Room Booking</h1>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="hidden sm:block text-sm text-gray-500">{userEmail}</div>
